 ...
 */
angular.module('controlPanelApp').controller('BusesCrossedStopReportController', BusesCrossedStopReportController);

function BusesCrossedStopReportController(ReportService, $scope, $state, $localStorage, $filter, MonitoringService, $timeout, $rootScope, Constants, MiscServices) {
    ...
    function loadData(tableState) {
        ...
        if (self.selectedStop == null) return;
    ...
    self.reportFileName = function (fileType) {
        return MiscServices.generateReportFileName('BusesCrossedGivenStop', fileType);
    }
